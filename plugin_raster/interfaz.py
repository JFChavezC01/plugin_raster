...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(618, 524)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(20, 40, 531, 391))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txtEdt1 = QtWidgets.QTextEdit(self.groupBox)
        self.txtEdt1.setGeometry(QtCore.QRect(20, 210, 501, 161))
        self.txtEdt1.setObjectName("txtEdt1")
        self.Btn2 = QtWidgets.QPushButton(self.centralwidget)
        self.Btn2.setGeometry(QtCore.QRect(20, 480, 75, 23))
        self.Btn2.setObjectName("Btn2")
        self.Btn3 = QtWidgets.QPushButton(self.centralwidget)
        self.Btn3.setGeometry(QtCore.QRect(230, 480, 75, 23))
        self.Btn3.setObjectName("Btn3")
        self.Btn4 = QtWidgets.QPushButton(self.centralwidget)
        self.Btn4.setGeometry(QtCore.QRect(480, 480, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Datos de la capa"))
